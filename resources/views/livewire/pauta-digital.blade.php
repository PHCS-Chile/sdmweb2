...
<div>
    ...
    <div class="flex space-x-4 pt-6 px-6">
        <div class="flex-1 w-1/4 py-8 px-6 bg-white shadow-xl sm:rounded-lg overflow-y-scroll h-screen">
            @if($evaluacion['estado_conversacion'] > 7)
                @foreach($grabaciones->all() as $posicion => $grabacion)
                    {!!$grabacion->url !!}
                @endforeach

            @else
                <form action="{{route('evaluacions.guardaeval', $evaluacion_id)}}" method="POST">
                    @csrf
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-1 ">
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-yellow-50 space-y-6 sm:p-6">
                                ...
                                @include('componentes.formularios.pauta_grupo', [
                                    'titulo' => 'Usuario', 'elementos' => [67, 68, 69, 70, 71, 73 ,74],
                                ])

                                @include('componentes.formularios.pauta_grupo', [
                                    'titulo' => 'Negocio', 'elementos' => [75, 76, 77, 78, 79, 80],
                                ])

                                @include('componentes.formularios.pauta_grupo', [
                                    'titulo' => 'Cumplimiento', 'elementos' => [81, 82, 83, 84],
                                ])
                        ...
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-blue-50 space-y-6 sm:p-6">
                                ...
                                @include('componentes.formularios.pauta_grupo', [
                                    'titulo' => 'Asistente Virtual', 'elementos' => [85, 86, 87],
                                ])

                                @include('componentes.formularios.pauta_grupo', [
                                    'titulo' => 'Gestiones anteriores', 'elementos' => [88, 89, 90],
                                ])

                                @include('componentes.formularios.pauta_grupo', [
                                    'titulo' => 'Usuarios', 'elementos' => [91, 92, 93],
                                ])
