                            ...
                            <div class="mt-5 md:mt-0 md:col-span-1 ">
                                    ...
                                    <div class="px-4 py-5 bg-green-50 space-y-6 sm:p-6">
                                        ...
                                        @if($evaluacion['sub_estudio'] == 'MovilHogar' || $evaluacion['sub_estudio'] == 'Subtel')
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                ...
                                                'padre' => 339,
                                                'elementos' => [340, 342, 343]
                                            ])
                                        @else
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                'titulo' => '4 - Demuestra seguridad y buen manejo de la información',
                                                'padre' => 339,
                                                'elementos' => [341, 342, 343]
                                            ])
                                        @endif
                                        @include('componentes.formularios.pauta_grupo_padre', [
                                ...
                                <div class="mt-5 shadow overflow-hidden sm:rounded-md">
                                    <div class="px-4 py-5 bg-red-50 space-y-6 sm:p-6">
                                        ...
                                        @include('componentes.formularios.pauta_grupo_padre', [
                                            'titulo' => '14 - Cumple con los protocolos de la plataforma',
                                            'padre' => 411,
                                        ])
                                    </div>
                                </div>
                            ...
                            <div class="mt-5 md:mt-0 md:col-span-1 ">
                                <div class="shadow overflow-hidden sm:rounded-md">
                                    <div class="px-4 py-5 bg-yellow-50 space-y-6 sm:p-6">
                                        ...
                                        @if($evaluacion['sub_estudio'] == 'MovilHogar')
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                'titulo' => '7 - Analiza correctamente los antecedentes',
                                                'padre' => 353,
                                                'elementos' => [354, 356, 357, 358, 359, 360, 363, 364]
                                            ])
                                        @elseif($evaluacion['sub_estudio'] == 'Subtel')
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                'titulo' => '7 - Analiza correctamente los antecedentes',
                                                'padre' => 353,
                                                'elementos' => [354, 356, 357, 358, 359, 360, 361, 362, 363, 364]
                                            ])
                                        @else
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                'titulo' => '7 - Analiza correctamente los antecedentes',
                                                'padre' => 353,
                                                'elementos' => [355, 359, 360, 361, 362, 363]
                                            ])
                                        @endif
                                        @if($evaluacion['sub_estudio'] == 'MovilHogar' || $evaluacion['sub_estudio'] == 'Subtel')
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                ...
                                                'padre' => 365,
                                                'elementos' => [366, 367, 369, 370, 371, 373]
                                            ])
                                        @else
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                'titulo' => '8 - Entrega información Completa',
                                                'padre' => 365,
                                                'elementos' => [366, 368, 369, 370, 372, 373]
                                            ])
                                        @endif
                                        @if($evaluacion['sub_estudio'] == 'MovilHogar' || $evaluacion['sub_estudio'] == 'Subtel')
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                ...
                                                'padre' => 374,
                                                'elementos' => [375, 376, 378, 379, 380, 382]
                                            ])
                                        @else
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                'titulo' => '9 - Entrega información Correcta',
                                                'padre' => 374,
                                                'elementos' => [375, 377, 378, 379, 381, 382]
                                            ])
                                        @endif
                                        @if($evaluacion['sub_estudio'] == 'MovilHogar' || $evaluacion['sub_estudio'] == 'Subtel')
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                ...
                                                'padre' => 383,
                                                'elementos' => [384, 385, 387, 388]
                                            ])
                                        @else
                                            @include('componentes.formularios.pauta_grupo_padre_condicional', [
                                                'titulo' => '10 - Gestiona correctamente en sistema los cambios o solicitudes',
                                                'padre' => 383,
                                                'elementos' => [384, 386, 387, 388]
                                            ])
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="shadow overflow-hidden sm:rounded-md">
                                    <div class="px-4 py-5 bg-blue-50 space-y-6 sm:p-6">
                                        ...
                                        @include('componentes.formularios.pauta_grupo', [
                                            'titulo' => '15 - Caracterización de la Interacción', 'elementos' => [416, 417, 418, 419, 420, 421, 422, 423],
                                        ])
