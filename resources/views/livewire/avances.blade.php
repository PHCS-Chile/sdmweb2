<div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        @foreach($usuarios as $usuario)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        {{$this->completasmes($usuario->id)}}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        {{$this->completashoy($usuario->id)}}
    ...
    <div class="flex flex-col max-w-8xl mx-auto sm:px-6 lg:px-8 pt-10">
        <div class="my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        @foreach($evaluaciones as $evaluacion)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        {{$evaluacion->asignacion->agente->servicio->name . " " . $evaluacion->asignacion->agente->habilidad}}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        @switch($evaluacion->estado_reporte)
                                            @case(11)
                                            Pendiente Revisión
                                            @break

                                            @case(12)
                                            Revisado Para Enviar
                                            @break
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        @if($evaluacion->fecha_supervision)
                                            {{date('d-m-Y H:i', strtotime($evaluacion->fecha_supervision))}}
                                        @endif
                                    </div>
                                </td>
