            ...
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <div class="flex flex-row inline-flex items-center my-5">
                            <div>
                                <p class="ml-5 text-gray-600 font-bold">Estudio:&nbsp&nbsp</p>
                            </div>

                            <div>
                                <div class="text-sm text-gray-500">
                                    <select id="filtroEstudio" name="filtroEstudio" autocomplete="" wire:model="filtroEstudio" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        {{$evaluacion->asignacion->agente->servicio->estudio->name}}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
